...
const sendReplyEmail = async (email: string, replyMessage: string) => {
  ...
  const mailOptions = {
    from: `Tradieez ${config.smtp_from}`, //sender email address//smtp-username
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td align="center">
                        ...
                        <!-- Company Name -->
                        <h1 style="color: #ffffff; margin: 0 0 8px 0; font-size: 32px; font-weight: 700; letter-spacing: -0.5px;">Tradieez</h1>
